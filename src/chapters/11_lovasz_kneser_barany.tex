...
Egyértelműen bontsuk az alapkört maximális olyan ívekre, melyeken belül minden második pont $A$-hoz tartozik. Ezek legyenek $T_1, T_2, \dots T_{n-2k}$. Tegyük fel hogy $T_1$ nem egyetlen pontú (legalább három pontja van). Két szélső pontja legyen $a, b$, illetve $T_0 := T_1 \backshlash \{a, b\}$.
